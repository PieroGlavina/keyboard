...
const CustomizerContainer = ({isCaseVisible, isPcbVisible, isPlateVisible, isSwitchVisible, isKeycapsVisible}) => {
    return (
            ...
            <Canvas>
                ...
                <Suspense fallback={null}>
                    <group position={[0, -0.1, 0]} scale={1.3}>
                        <Case visible={isCaseVisible}/>
                        <PCB position={[0, 0.05, 0]} visible={isPcbVisible}/>
                        <Plate position={[0, 0.1, 0]} visible={isPlateVisible}/>
                        <Switches position={[0, 0.15, 0]} visible={isSwitchVisible}/>
